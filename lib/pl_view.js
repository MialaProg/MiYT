...
function setYouTubeVideoTitle(videoId) {
    ...
    fetch(apiUrl)
      ...
      .then(data => {
        ...
        document.getElementById(`pl_view_${my_id}`).innerHTML += videoTitle;
...
function plv_load_title(){
    ...
    pl_view_load_idx += 1;
      ...
      setYouTubeVideoTitle(playlist[my_id]);
}
