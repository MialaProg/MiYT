console.log('inFileSvg.js >> V0.03.2.00');

actual_ver = "V0.03.2.00";
...
function RestaureFromInFile(data) {
    if (data["saver_version"] == "V0.03.2.00") {
        if ("watch_id" in data){
            id = data["watch_id"];
        }
    }
...
let elementFichier = document.getElementById("fichierRestauration");
